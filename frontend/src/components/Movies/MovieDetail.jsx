...
const movie = {
  ...
  votes:"250k",
  img:m4,
  languages:["English","Hindi","Tamil","telgu"],
  format:["2D","IMAX","3D","4DX"],
  certification:"UA16+",
  duration:"2h 30m",
  releaseDate:"2025-12-25",
  description:"An epic sports drama that follows the journey of an underdog racer as they navigate the high-octane world of Formula 1, overcoming personal obstacles and professional rivalries to chase their championship dreams.",
  
}

const formateReleaseDate = (dateString) => {
    ...
    {/* movie detail section */}
     ...
     style = {{
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col lg:flex-row gap-10">
        ...
        {/* details */}
        <div className="flx flex-col justify-start flex-1">
          ...
          <div className="flex flex-col items-start gap-4 mb-3">
            ...
            <p className="text-m text-gray-300 mb-4">
              {movie?.duration}  |  {movie?.genere.join(",")}  |  {movie?.certification}  | {formateReleaseDate(movie?.releaseDate)} 
      ...
      <div className="flex flex-wrap items-center gap-2 mb-2">
        {
          filters.map((filter,i)=>(
            <button className="border border-gray-300 px-5 py-1 rounded-lg cursor-pointer text-m hover:bg-[#f74362]" key={i}>
              {filter}
            </button>
          ))
        }
