  ...
  return (
    <div className='w-full md:w-3/4 p-4'>
      <div className='flex justify-between items-center bg-white px-6 py-6 rounded mb-6'>
        <h3 className='font-semibold text-xl text-[#f74362]'>Upcoming Movies</h3>
        <a href='#' className='text-[#f74362] text-sm font-medium hover:underline'>
      ...
      {moviesToShow.length === 0 ? (
        <div className='flex flex-col items-center justify-center py-20 text-gray-500'>
          <p className='text-lg font-medium'>No movies match the selected filters.</p>
